...
issue](https://github.com/cisagov/cool-system/issues) in this
...
request](https://github.com/cisagov/cool-system/pulls), you will
...
```console
cd cool-system
pyenv virtualenv <python_version_to_use> cool-system
pyenv local cool-system
